...
export const RecommendationsSlider = () => {
  const reccomendationsList = <Elements.RecommendationsList>
  ...
  return (
    <Container>
      <H2 style={{ textAlign: "center", color: theme.light.palette.brown, marginTop: "50px" }}>Рекомендації</H2>
      {RECCOMENDETION_ITEMS.length < 5 ? reccomendationsList :
      ...
      {RECCOMENDETION_ITEMS.length === 0 && <P style={{ textAlign: "center", margin: "50px 0" }}>Нічого не знайдено</P>}
    </Container>
  );
}